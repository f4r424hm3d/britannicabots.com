...
<div class="main pt-80">
  ...
  <section class="about-us-section ptb-70">
    <div class="container">
          ...
          <div id="accordion-1" class="accordion accordion-faq">
            ...
            <div class="card">
              <div class="card-header py-4" id="heading-1-1" data-toggle="collapse" role="button"
                ...
                <h5 class="mb-0"><span class="ti-receipt mr-3"></span>Project Terms</h5>
              </div>
              <div id="collapse-1-1" class="collapse" aria-labelledby="heading-1-1" data-parent="#accordion-1">
                <div class="card-body">
                  <p class="mb-2">All estimates/quotes are based on our understanding of your requirements and as per
                  ...
                  <p class="mb-2">Clients to ensure that we have included all requirements in the
                    ...
                    with clear guidelines along with the flow or specific details they may require. When such details
                    are not provided, we will proceed with our understanding of the requirements and quote accordingly.
                    At a later stage, if a discrepancy arises, it may lead to additional costs to accommodate the
                    changes. Thus, it is essential that you clarify every aspect of your website development and ensure
                    that you have been quoted on the right requirements.
                  ...
                  <p class="mb-2">Any bugs (programming errors) reported during or just after the development does not
                    attract additional charges.</p>
                  <p class="mb-2">Any re-work on an already completed task will attract additional charges. Any changes
                  ...
                  <p class="mb-2">Any modifications requested during the development or after the Go-Live approval will
                    ...
                    charges if it goes beyond reasonable timeframe.</p>
                  <p class="mb-2">Our websites/applications are generally tested on PCs and include near recent versions
                    of following browsers: IE, Firefox, Chrome & Safari. If you require testing to be done on any other
                  ...
                  <p class="mb-2">Please note that at any stage during the project, stalling of the project for over two
                    calendar months will incur INR5000/week administration costs. Furthermore, it may increase the
                    previously approved estimates. If you require the project to be put on hold, please advise us in
                  ...
                  <p class="mb-2">The website or software application will be designed to be deployed on the web, via
                    using a commercial grade web-server or a similar setup. Based on your website traffic, the website
                  ...
                  <p class="mb-2">The client must recognize that at times there may be unforeseen circumstances that
                    will delay the development process, particularly with reference to the integration of third party
                    software. We will try our best to complete the project as agreed in the proposal. As long as it is
                    within a reasonable period, the client agrees not to penalize us for any genuine delay, when every
                    effort to keep the project on the proposed schedule is taken.</p>
                  <p class="mb-2">Domain registration/renewal etc charges are not included as a part of any
                    project/proposal unless mentioned otherwise. If required, a quote for which will be submitted
                    separately and approved by the client.</p>
                  <p class="mb-2">Hosting charges are not included in the quotations unless mentioned otherwise. Axis
                    Web Intelligence can organise an appropriate hosting solution if required, a quote for which will be
                  ...
                  <p class="mb-2">Nothwithstanding any other provision in the agreement, in consideration of the
                    ...
                    digital strategies, programming codes, database structures, scripts, forms or functionalities.</p>
                  <p>All communications/correspondences are generally done via emails. It is client’s responsibility to
                    keep us updated with their relevant email addresses.</p>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              <div class="card-header py-4" id="heading-1-2" data-toggle="collapse" role="button"
                ...
                <h5 class="mb-0"><span class="ti-receipt mr-3"></span>Digital Marketing/Strategy Terms</h5>
              </div>
              <div id="collapse-1-2" class="collapse" aria-labelledby="heading-1-2" data-parent="#accordion-1">
                <div class="card-body">
                  <h6 class="color-black"><strong>Digital Marketing Package or Digital Strategy Package Terms:</strong>
                  </h6>
                  ...
                  <p class="mb-2">They are billed monthly and are payable by the 1st of every month.</p>
                  ...
                  <p class="mb-2">Britannica Bots Intelligence employs fair use policy, which means that although we
                    ...
                    sometimes.</p>
                  <p class="mb-2">Any extra hours used may be billed separately. Any urgent tasks will be charged
                    separately.</p>
                  <p class="mb-2">Support requests need to be sent via email to support@axiswi.com</p>

                  <h6 class="color-black"><strong>Payment terms:</strong></h6>
                  <p class="mb-2">Payable by the 1st of every month. We strongly recommend our clients to have a direct
                    debit set-up for the same.</p>
                  <p class="mb-2">An administrative fee of INR 1500 will be charged to the clients account for any late
                    payments or declined credit card charges.</p>
                  <p class="mb-2">There are absolutely no refunds for any fees related to the digital marketing/strategy
                    package.</p>
            ...
            <div class="card">
              <div class="card-header py-4" id="heading-1-3" data-toggle="collapse" role="button"
                ...
                <h5 class="mb-0"><span class="ti-receipt mr-3"></span>Annual Maintenance Terms</h5>
              </div>
              <div id="collapse-1-3" class="collapse" aria-labelledby="heading-1-3" data-parent="#accordion-1">
                <div class="card-body">
                  <h6 class="color-black"><strong>Basic Annual Maintenance Package Terms:</strong></h6>
                  <p class="mb-2">All digital marketing/strategy packages are for a minimum of 3 months period.
                    Thereafter, cancel anytime with clear one-month email notice.</p>
                  <p class="mb-2">They are billed monthly and are payable by the 1st of every month.</p>
                  <p class="mb-2">Packages are designed with keeping in mind the Digital Marketing/Strategy requirements
            ...
            <div class="card">
              <div class="card-header py-4" id="heading-1-4" data-toggle="collapse" role="button"
                ...
                <h5 class="mb-0"><span class="ti-receipt mr-3"></span>General Approach</h5>
              </div>
              <div id="collapse-1-4" class="collapse" aria-labelledby="heading-1-4" data-parent="#accordion-1">
                <div class="card-body">
                  <h6 class="color-black"><strong>For general website design & development projects we employ the
                      following steps:</strong></h6>
                  <p class="mb-2">Upon quote acceptance/signoff, initiation payment is processed to start the project.
                    As required by the project, we may hold a Scoping Workshop to discuss the requirements in detail.
                  </p>
                  <p class="mb-2">Once we have the brand details such as logo, images, branding materials etc, we will
                    have a mock-up for your review within 5 to 10 working days.
                  <p class="mb-2">You can review the design and suggest improvements accordingly. Depending upon your
                    project, generally up to 3 to 5 design modifications that can be done within the given estimates.
                    Please refer to your allocated design and development hours for details.</p>
                  <p class="mb-2">Once the design is finalized & approved, we’ll proceed with the HTML development. At
                    this stage, we generally need around 3 to 5 banner text and/or images for rotation.</p>
                  <p class="mb-2">Once, HTML is done, if CMS is included in your project, we will proceed to set up your
                    website on your selected Content Management System (CMS). Please provide all content and copy prior
                    to the development phase.</p>
                  <p class="mb-2">Depending upon the time and resources allocated to your project, we’ll transfer as
                    much content as possible from the old website to the new website. The remaining content can be
                    transferred via the CMS by your designated staff. We can provide the instructions needed to help you
                    do this.</p>
                  <p class="mb-2">Once the site is ready from our end, we generally hand it over to you for further
                    review, test and/or to upload/change contents as necessary.
                    At this stage you need to give us a Go-Live date for us to make the new website/project live.</p>
                  <p class="mb-2">Your website can be made live within 3 to 5 working days of a Go Live approval,
                    assuming that the accounts are clear. Kindly note that we require full payment prior to transferring
                    the website on any external servers.</p>
                  <p class="mb-2">Kindly note, there are limited man-hours allocated on the project. The estimates for
                    all websites under INR 5,00,000/- are based on an assumption that projects will to be completed over
                    eight to twelve working weeks depending upon the size of your project. Any further delays may
                    increase project management costs. If you do not believe the project to be completed within this
                    time frame, please do let us know prior to starting the project.
                    Also, generally speaking, going-back and forth takes a lot of time. We encourage you to provide all
                    necessary details, at the start of the project to ensure that the project team’s time is efficiently
                    utilized on your project and you do not incur any unnecessary additional costs.</p>
                  <p class="mb-2">You will be kept updated via emails and/or telephone calls as the project demands.
                    However, please do not hesitate to contact us any time you require a project status. Also, please
                    always keep us updated with your relevant email addresses/contact details.</p>
                  <p class="mb-2">Once the website/application has been made live on the client’s domain, it is their
                    responsibility to take regular full back-ups and to update all components and third party software.
                  </p>
                  <p>We consider ourselves to be very flexible and adaptable and approach all requests with a ‘can do’
                    attitude. If you require something changed, please feel free to discuss it with us. Please contact
                    us if you require further details or have any questions. We look forward to working together with
                    you on your project!</p>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              <div class="card-header py-4" id="heading-1-5" data-toggle="collapse" role="button"
                ...
                <h5 class="mb-0"><span class="ti-receipt mr-3"></span>Payment/Refund Terms</h5>
              </div>
              <div id="collapse-1-5" class="collapse" aria-labelledby="heading-1-5" data-parent="#accordion-1">
                <div class="card-body">
                  <h6 class="color-black"><strong>For general website design & development projects we employ the
                      following steps:</strong></h6>
                  <p class="mb-2">All prices are quoted in Indian Rupees are inclusive of GST unless specified.</p>
                  <p class="mb-2">All invoices are to be processed as per the schedule via your preferred method of
                    payment.</p>
                  <p class="mb-2">There is a surcharge charged for payments made via online payment gateways. This is
                    charged by payment merchants for the credit card payments.</p>
                  <p class="mb-2">Milestone payments must be made within 5 working days of each milestone/schedule
                    unless mutually agreed otherwise. Final payment must be made prior to website/application/project
                    going live.</p>
                  ...
                  <p class="mb-2">Britannica Bots Intelligence reserves the right to negotiate and refund the
                    ...
                    charge will be 50% of the invoice. There will be no refund or adjustments if cancellation is called
                    when more than 50% of the work has been completed. All cancellations must be received in writing and
                    can be sent via regular mail, email or fax. Telephone requests on cancellations will not be
                    accepted.</p>
                  <p class="mb-2">For minor or once-off works, payments need to be made either in advance or as per the
                    terms mentioned in the invoice/proposal. If you require any changes to the terms, you must inform us
                    in writing (emails accepted) within two working days of the receipt of the same.</p>
                  <p class="mb-2"><strong>Late fees and charges:</strong> All outstanding invoices will incur a late
                    payment fee of 10% of the pending amount and an administration fee of INR 500 per month, from the
                    due date.</p>
                  <p class="mb-2"><strong>Due date:</strong> Is the date on which the payment is due as per the terms on
                    the invoice/proposal</p>
                  <p class="mb-2"><strong>Outstanding Invoice:</strong> An invoice is deemed to be outstanding if the
                  ...
                  <p class="mb-2">If you are late with a payment or have any queries regarding the Invoice, please
                    contact Accounts Manager immediately on receiving the invoice or reminder emails.</p>
                  All communications/correspondences are generally done via emails. It is client’s responsibility to
                  keep us updated with their relevant email addresses.
            ...
            <div class="card">
              <div class="card-header py-4" id="heading-1-6" data-toggle="collapse" role="button"
                ...
                <h5 class="mb-0"><span class="ti-receipt mr-3"></span>Dispute, Liability And Indemnity</h5>
              </div>
              <div id="collapse-1-6" class="collapse" aria-labelledby="heading-1-6" data-parent="#accordion-1">
                <div class="card-body">
                  ...
                  <p class="mb-2">Client will indemnify and hold Britannica Bots Intelligence, its licensors, content
                    ...
                    limitation, any use of content other than as expressly authorized in these Terms and Conditions.
                    Client agrees that the indemnified parties will have no liability in connection with any such breach
                    or unauthorized use, and you agree to indemnify and hold harmless the Indemnified Parties from any
            ...
            <div class="card">
              <div class="card-header py-4" id="heading-1-7" data-toggle="collapse" role="button"
                ...
                <h5 class="mb-0"><span class="ti-receipt mr-3"></span>Hosting</h5>
              </div>
            ...
            <div class="card">
              <div class="card-header py-4" id="heading-1-8" data-toggle="collapse" role="button"
                ...
                <h5 class="mb-0"><span class="ti-receipt mr-3"></span>Intellectual Property</h5>
              </div>
