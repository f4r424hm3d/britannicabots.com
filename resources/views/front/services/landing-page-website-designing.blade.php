      ...
      <div class="row d-flex align-items-center">
        <div class="col-md-7 col-lg-7">
          <div class="about-us-content-wrap pr-4">
            <h2><span class="color-secondary">Landing Page</span> Website Designing Company Gurugram</h2>
      ...
      <div class="row d-flex align-items-center">
        <div class="col-md-12 col-lg-12">
          <div class="about-us-content-wrap pr-4 wow fadeInUp animated" data-wow-duration="1.5s">
            <h2>What is a <span class="color-secondary">Landing Page?</span></h2>
            <span class="animate-border mb-4"></span>
            <p class="lead">A landing page is a single-page web page that appears after clicking on an online
              advertisement, such as PPC or Facebook ads, and includes all necessary information for the ad presented.
