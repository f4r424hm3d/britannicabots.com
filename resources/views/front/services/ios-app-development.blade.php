      ...
      <div class="row align-items-center">
        <div class="col-md-12 col-lg-6">
          <div class="hero-slider-content text-white">
            ...
            <p class="lead">Britannica Bots is widely recognised as the best IOS App Development Company in Gurugram since, and we have worked with over 100 firms globally. We prioritise customer relationships above
