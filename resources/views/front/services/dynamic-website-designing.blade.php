      ...
      <div class="row align-items-center">
        <div class="col-md-12 col-lg-7">
          <div class="hero-slider-content text-white">
            ...
            <p class="lead">Britannica Bots is widely recognised as the best Dynamic Designing Company in Gurugram since
    ...
    <div class="container">
      <div class="row wow fadeInUp animated" data-wow-duration="1.5s">
        <div class="col-md-3 col-sm-6 col-12 mb-3">
          <div class="promo-item pb-3 mt-0 single-promo-hover h-100">
            <div class="promo-img">
