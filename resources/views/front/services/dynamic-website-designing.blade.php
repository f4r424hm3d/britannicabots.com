      ...
      <div class="row align-items-center">
        <div class="col-md-12 col-lg-7">
          <div class="hero-slider-content text-white">
            ...
            <p class="lead">Britannica Bots is widely recognised as the best Dynamic Designing Company in Gurugram since, and we have worked with over 100 firms globally. We prioritise customer relationships above
              high-ticket proposals.</p>
          </div>
        </div>
        <div class="col-md-12 col-lg-5">
          <div class="wow fadeInRight animated" data-wow-duration="2s"><img src="{{url('front')}}/img/dynamik-web.png"
              class="img-fluid float-ani" alt="hero">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row d-flex align-items-center">
        <div class="col-md-7 col-lg-7">
          <div class="about-us-content-wrap pr-4">
            ...
            <p>At Britannica Bots, our highly skilled team of professional web developers, web designers, creative
              graphic design specialists, and design experts collaborate to view your organisation in any visual format
              you require.</p>
        ...
        <div class="col-md-5 col-lg-5">
          <div class="image-frame wow fadeInRight animated" data-wow-duration="2s"><img
              src="{{url('front')}}/img/dynamik-web-designing.jpg" alt="about us" class="img-fluid"></div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="why-choose-us ptb-100" id="start">
    <div class="container">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-5 col-lg-5">
          <div class="wow fadeInRight animated" data-wow-duration="2s"><img src="{{url('front')}}/img/dynamik-web2.png"
        ...
        <div class="col-md-12 col-lg-12">
          <div class="about-us-content-wrap pr-4 wow fadeInUp animated" data-wow-duration="1.5s">
            ...
            <p class="lead">Gurugram is a massive metropolitan area in India's north. Gurugram is considered as the core
              ...
              exported from Gurugram. We, as a web development agency in Gurugram, assist our clients with suitable
              guidance and method.</p>
            <p class="lead">In today's digital age, staying connected with your consumers and prospects is critical for
              capturing new markets and expanding your business. According to statistics, over 4.57 billion individuals
              worldwide are active internet users, accounting for 59 percent of the global population.</p>
