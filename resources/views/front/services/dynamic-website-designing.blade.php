      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-12 col-lg-5">
          <div class="wow fadeInRight animated" data-wow-duration="2s"><img
              src="{{ url('/front/') }}/img/dynamik-web.png" class="img-fluid float-ani" alt="hero">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row d-flex align-items-center">
        <div class="col-md-7 col-lg-7">
          <div class="about-us-content-wrap pr-4">
            ...
            <p>Britannica Bots is a dynamic website design firm situated in Gurugram that offers dynamic website
              design, responsive web design, and ecommerce development in India.</p>
            <p>At Britannica Bots, our highly skilled team of professional web developers, web designers, creative
              graphic design specialists, and design experts collaborate to view your organisation in any visual
