      ...
      <div class="row align-items-center">
        <div class="col-md-12 col-lg-6">
          <div class="hero-slider-content text-white">
            <h1 class="text-white">Payment Gateway Integration company for any business</h1>
            <p class="lead">With e-commerce and online shopping increasing at exponential rates these days, it is
              essential that your online store is integrated with a multiple payment gateway. Payment Gateway
              Integration Services in Pune is used to process credit and debit card transactions when accepting online
              orders from your customers. These payment gateways are provided by various banks and other dedicated
              payment processors.</p>
          </div>
        </div>

        <div class="col-md-12 col-lg-6 wow fadeInRight animated" data-wow-duration="2s">
          <div class="image-wrap"><img src="{{ url('/front/') }}/img/payment-gateway.png" alt="hero"
      ...
      <div class="row d-flex align-items-center">
        <div class="col-md-7 col-lg-7">
          <div class="about-us-content-wrap pr-4">
            <h2><span class="color-secondary">Payment Gateway</span> Integration Service</h2>
            <span class="animate-border mb-4"></span>
            <p>The needs for an account vary from service to service, with specific requirements described on the web
              sites of most gateway providers. We have proven an expertise in the field of payment gateway on
              different e-commerce shopping cart software. We can able to satisfy a large number of merchants with
              their payment gateway integration. At Nucleosys Tech, we are one of the outstanding Payment Gateway
              Integration Company in Pune, India; we can do the payment gateway integration with your shopping cart so
              that you can easily process all type of cards payments on your website. All you need to do is let us
              know which payment gateway service you are using and we will do the rest of the work. We are familiar
              with most popular payment gateways.</p>
            <p>With Nucleosys Technologies, Set up a payment gateway if you want to take your website to the next
              level and receive more clients. If you have a business web host, you may already have a payment gateway
              access; otherwise we would help you to apply this service or locate some other modes to integrate this
              into your website. We develop payment gateway integration with highest conversion rates to minimize the
              loading time during the payment process.
              Nucleosys is a well-experienced E-Commerce website development services and we know the ins-and-outs of
        ...
        <div class="col-md-5 col-lg-5">
          <div class="image-frame wow fadeInRight animated" data-wow-duration="2s"><img
              src="{{ url('/front/') }}/img/payment-gateway.jpg" alt="about us" class="img-fluid"></div>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="row justify-content-center">
        <div class="col-md-12 col-lg-12">
          <div class="section-heading text-center">
            <h2>What is Payment Gateway Integration?</h2>
            <span class="animate-border mr-auto ml-auto mb-4"></span>
            <p>In this digital age, people tend to search their requirement, whether in product or services online.
              When people searches related to your offering in your locality, and your business is found to them which
              can add new sale for you. More than 45% of searches are based on local area, that’s why we placed great
              care into developing local SEO services that are flexible for businesses of any size. Local SEO services
              is useful for new or established business looking to maximize your local presence.</p>
          </div>
        </div>
      </div>
      <div class="row align-items-center">
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6 promo-col">
                <div class="promo-item pb-2">
                  <h5 class="mb-4">Profile Creation</h5>
                  <div class="promo-bottom-shape">
                    <img src="{{ url('/front/') }}/img/promo-box-shape-bottom.png" alt="shape">
                  </div>
                </div>
                <div class="promo-item pb-2">
                  <h5 class="mb-4">Account Optimization</h5>
                  <div class="promo-bottom-shape">
                    <img src="{{ url('/front/') }}/img/promo-box-shape-bottom.png" alt="shape">
                  </div>
                </div>
                <div class="promo-item pb-2">
                  <h5 class="mb-4">Creative Post</h5>
                  <div class="promo-bottom-shape">
                    <img src="{{ url('/front/') }}/img/promo-box-shape-bottom.png" alt="shape">
                  </div>
                </div>
                <div class="promo-item pb-2">
                  <h5 class="mb-4">Website/blog Link Post</h5>
                  <div class="promo-bottom-shape">
                    <img src="{{ url('/front/') }}/img/promo-box-shape-bottom.png" alt="shape">
                  </div>
                </div>
              ...
              <div class="col-md-6 col-sm-6 promo-col">
                <div class="promo-item pb-2">
                  <h5 class="mb-4">Trending & Relevant Hashtags</h5>
                  <div class="promo-bottom-shape">
                    <img src="{{ url('/front/') }}/img/promo-box-shape-bottom.png" alt="shape">
                  </div>
                </div>
                <div class="promo-item pb-2">
                  <h5 class="mb-4">Post Sharing at Social Groups</h5>
                  <div class="promo-bottom-shape">
                    <img src="{{ url('/front/') }}/img/promo-box-shape-bottom.png" alt="shape">
                  </div>
                </div>
                <div class="promo-item pb-2">
                  <h5 class="mb-4">Festive Creative Posts</h5>
                  <div class="promo-bottom-shape">
                    <img src="{{ url('/front/') }}/img/promo-box-shape-bottom.png" alt="shape">
                  </div>
                </div>
                <div class="promo-item pb-2">
                  <h5 class="mb-4">Comments & Messages Management</h5>
                  <div class="promo-bottom-shape">
                    <img src="{{ url('/front/') }}/img/promo-box-shape-bottom.png" alt="shape">
                  </div>
                </div>
        ...
        <div class="col-md-5 col-lg-5">
          <div class="image-wrap wow fadeInRight  animated" data-wow-duration="2s"><img
              src="{{ url('/front/') }}/img/payment-gatway2.png" alt="shape" class="img-fluid float-ani"></div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="why-choose-us ptb-100 gray-light-bg">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-12 col-lg-12">
          <div class="section-heading text-center">
            <h2>Why Choose Britannica Boats</h2>
            <span class="animate-border mr-auto ml-auto mb-4"></span>
          </div>
          ...
          <div class="timeline">
            <div class="timeline__event animated fadeInDown timeline__event--type2">
              ...
              <div class="timeline__event__content">
                <div class="timeline__event__title">Worked with esteemed Clients & Years of Experience</div>
                <div class="timeline__event__description">
                  <p>We are creating awesome websites and apps since 2012 and worked for hundreds of businesses to be
                    successful with their online marketing efforts. We create websites that are attractive, simple to
                    use, and drive results for your company. We use our knowledge and expertise to help our clients
                    take their business to the next level with results-driven e-marketing solutions.</p>
                </div>
              </div>
            </div>
            ...
            <div class="timeline__event animated fadeInDown delay-2s timeline__event--type3">
              ...
              <div class="timeline__event__content">
                <div class="timeline__event__title">We are Goal Oriented & ROI-Driven Focused</div>
                <div class="timeline__event__description">
                  <p>A great website cam ease, monitor and measure all your marketing efforts. We understand that the
                    website is an important part of your business and you want the expected outcome from the website.
                    We design SEO-Friendly website and mobile responsive website with integration of all the important
                    tools that allows the tracking and analysis of website performance.</p>
                </div>
              </div>
            </div>
            <div class="timeline__event animated fadeInDown delay-3s timeline__event--type1">
              ...
              <div class="timeline__event__content">
                <div class="timeline__event__title">Use of Standard Codings Quality checks</div>
                <div class="timeline__event__description">
                  <p>Our web design & development team utilizes up-to-date coding practices with clean HTML5 and CSS3.
                    All of our websites are developed to look and perform beautifully on every device your users are
                    viewing it from. Also, we understand that Fast load times = happy customers. Google has made it
                    clear that they prefer websites that respond quickly.</p>
                </div>
              </div>
            </div>
          </div>
