        ...
        <div class="col-md-7 col-lg-7">
          <div class="about-us-content-wrap pr-4">
            ...
            <p class="lead">Expert graphic designers, brand consultants, and copywriters make up our brand designing
              ...
              designs achieve the goal of throughly describing each of a company's various products and services.</p>
    ...
    <div class="container">
      ...
      <div class="row mt-5">
        <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
          <div
            class=" h-100 text-center p-5  shadow-sm white-bg rounded wow zoomInDown animated"
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
          <div class=" h-100 text-center p-5  shadow-sm white-bg rounded wow zoomInDown animated"
