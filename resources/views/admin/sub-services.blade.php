              ...
              <div class="row">
                ...
                <div class="col-md-4 col-sm-12">
                  <div class="form-group mb-3">
                    ...
                    <input name="sub_service_name" type="text" class="form-control" placeholder="Enter Name"
                      value="{{ $ft == 'edit' ? $sd->sub_service_name : old('sub_service_name') }}">
                    <span class="text-danger">
              ...
              <tbody>
                ...
                <tr id="row{{ $row->id }}">
                  ...
                  <td>
                    ...
                    <a href="{{ url('admin/sub-services/update/' . $row->id) }}"
...
<script>
  ...
  function DeleteAjax(id) {
    ...
    if (cd == true) {
      $.ajax({
        url: "{{ url('admin/sub-services/delete') }}" + "/" + id,
        success: function(data) {
          if (data == '1') {
            $('#row' + id).remove();
            var h = 'Success';
