          ...
          <div class="card-body">
            <form action="{{ $url }}" class="needs-validation" method="post" enctype="multipart/form-data" novalidate>
              ...
              <div class="row">
                <div class="col-md-4 col-sm-12">
                  <div class="form-group mb-3">
                    ...
                    <select name="category_id" id="category_id" class="form-control">
                      ...
                      @foreach ($blogCategory as $ser)
                      <option value="{{ $ser->id }}" {{ $ft=='edit' && $sd->category_id == $ser->id ? 'Selected' : ''
                        }}>{{
                        $ser->name }}</option>
                      @endforeach
                    </select>
                ...
                <div class="col-md-12 col-sm-12">
                  <div class="form-group mb-3">
                    <label>Enter Shortnote</label>
                    <textarea name="shortnote" type="text" class="form-control" id="shortnote"
                      rows="2">{{ $ft == 'edit' ? $sd->shortnote : old('shortnote') }}</textarea>
                    <span class="text-danger">
                      @error('shortnote')
                      {{ $message }}
                      @enderror
                ...
                <div class="col-md-12 col-sm-12">
                  <div class="form-group mb-3">
                    ...
                    <textarea name="description" id="description" type="text" class="form-control" id="" cols="30"
                      rows="10">{{ $ft == 'edit' ? $sd->description : old('description') }}</textarea>
                    <span class="text-danger">
                      @error('description')
                      {{ $message }}
                      @enderror
